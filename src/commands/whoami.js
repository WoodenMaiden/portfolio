        ...
        <Container>
            <Stack sx={{ display: "flex", flexDirection: "column", justifyContent: "center"}}>
                ...
                <Typography variant="body1">
                    My name is Yann POMIE, I am currently a {new Date(Date.now() - new Date('June 19, 2001').getTime()).getFullYear() - 1970} years old french DevOps student at <a href="https://www.polytech.umontpellier.fr/formation/cycle-ingenieur/devops/en-quelques-mots-do">Polytech Montpllier</a>. 
                    ...
                    <br />
                    I discovered computer science around 2017 during high school thanks to lua and a framework called <a href='https://love2d.org/'>LÖVE2D</a>, and neer stopped learning ever since!
                    <br />
